...
class PinsControllerTest < ActionController::TestCase
  ...
  test "should create pin" do
    assert_difference('Pin.count') do
      post :create, pin: { description: @pin.description, ip: @pin.ip, user_id: @pin.user_id, when: @pin.when }
    end
  ...
  test "should update pin" do
    patch :update, id: @pin, pin: { description: @pin.description, ip: @pin.ip, user_id: @pin.user_id, when: @pin.when }
    assert_redirected_to pin_path(assigns(:pin))
  end
